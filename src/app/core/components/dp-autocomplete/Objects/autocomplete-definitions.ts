...
export class AutocompleteDefinitions implements IAutocompleteDefinition {
    ...
    */
    ...
    constructor(inputId: string, field: any,  dp_AutocompleteType?: number, multiple?: boolean, minLength?: number, placeholder?: string,
        dropdown?: boolean, dp_AutocompleteImagesPath?: string,
        ...
        , dp_AutocompleteMaxSuggestionsToShow?: number, emptyMessage?: string, name?: string) { /*, autocomplete?: string*/
