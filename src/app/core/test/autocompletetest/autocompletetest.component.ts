...
import { AutocompleteDefinitions } from '../../components/dp-autocomplete/Objects/autocomplete-definitions';
...
export class AutocompletetestComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    // 1 regular
    this.autocompleteDefinition1 = new AutocompleteDefinitions('elem_1111', 'name', 0, false, 1, 'ph text 1', false);

    // 2 regular
    this.autocompleteDefinition2 = new AutocompleteDefinitions('elem_2222', 'name', 0, true, 1, 'ph text 2', true);

    // 3 data with image
    this.autocompleteDefinition3 = new AutocompleteDefinitions('elem_3', '', 2, true, 1, 'ph text 3', true, '/assets/Images/collection_png_32x32/flags/flag_', 'png');

    // 4 load on click / open
    this.autocompleteDefinition4 = new AutocompleteDefinitions('elem_table_4', 'Event Code', 1, false, 1, 'ph text 4', true);

    // 5 table
    this.autocompleteDefinition5 = new AutocompleteDefinitions('elem_table', 'Event Code', 1, false, 1, 'ph text 5', true);
    ...
    this.autocompleteDefinition6 = new AutocompleteDefinitions('elem_table', 'Event Code', 1, false, 1, 'ph text 6', true, '', '', '', '', ''
      , ColumnsExtradata
    );
    ...
    this.countryService.get_data('assets/EventCodes.json').then(data_for_ac5 => {
      ...
      this.data_for_ac6 = data_for_ac5;
    });
